<x-app-layout>
    <x-slot name="header">
        <div class="flex w-full items-center">
            ...
            <div class="flex w-1/2 justify-end space-x-2 p-1 text-gray-200">
                <button class="flex justify-center w-40 border rounded p-1 border-lime-500 hover:bg-lime-600"
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col gap-4 content-center p-2 mt-4">
                @forelse ($recipes as $recipe)
                    <div
                        class="flex flex-col w-full text-slate-200 border border-lime-400 rounded p-1 print:border-white print:text-sm">
