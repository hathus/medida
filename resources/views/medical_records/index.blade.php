<x-app-layout>
    <x-slot name="header">
        ...
        <a href="{{route('nuevo-expediente')}}" class="border border-lime-500 rounded p-2 flex w-1/6 my-2 justify-center items-center text-gray-100 text-sm uppercase font-bold hover:bg-lime-500 hover:text-black">
