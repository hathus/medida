            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex gap-4 content-center mb-5">
                        <div class="border border-lime-300 rounded p-2 w-3/5">
                            <p>Nombre: <span>{{ $medicalRecord->name }}</span></p>
                        </div>
                        <div class="border border-lime-300 rounded p-2 w-2/5">
                            <p>Fecha de Registro: 
                                <span>
                    ...
                    <div class="flex gap-4 content-center mb-5">
                        <div class="border border-lime-300 rounded p-2 w-1/5">
                            <p>Edad:
                                <span>
                    ...
                    <div class="flex gap-4 content-center mb-5">
                        <div class="border border-lime-300 rounded p-2 w-1/2">
                            <p>Ciudad:
                                <span>
                                    {{ $medicalRecord->city }}
                                </span>
                    ...
                    <div class="flex gap-4 content-center mb-5">
                        <div class="border border-lime-300 rounded p-2 w-1/4">
                            <p>Peso:
                                <span>
