        ...
        <div class="bg-gray-100 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg border border-lime-300">
            @forelse ($consultas as $consulta)
                <div
                    ...
                    <div class="space-y-3 rounded-lg">
                        ...
                        <p>Glucosa:
                            <span
                                class="text-sm font-bold flex justify-start items-center {{ $consulta->glucose <= 120 ? 'text-lime-600' : 'text-red-600' }}">
                                @if ($consulta->glucose <= 120)
                                    ...
                                    {{ $consulta->glucose }} -> Glucosa Controlada
                                @else
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    {{ $consulta->glucose }} -> Glucosa Descontrolada
                                @endif
                            </span>
                        </p>
                        <p>
                            ...
                            @if ($consulta->imc < 18.5)
                                <span class="flex text-sm font-bold text-blue-600 justify-start items-center">
                                    ...
                                    {{ round($consulta->imc, 2) }}
                                    -> Bajo Peso
                                </span>
                            @elseif ($consulta->imc >= 18.5 && $consulta->imc <= 24.9)
                            ...
                            @elseif ($consulta->imc >= 25 && $consulta->imc <= 29.9)
            ...
            @empty
                <p class="p-3 text-center text-sm text-gray-200">
                    No existen consultas medicas en este momento para <span
                        class="bold text-bold">{{ $medical_record->name }}</span>.
                </p>
            @endforelse
        </div>
    </div>
