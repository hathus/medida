            ...
            @forelse ($expedientes as $expediente)    
                <div class="p-6 text-gray-900 dark:text-gray-100 md:flex md:justify-between md:items-center border border-lime-300">
                    ...
                    <div class="flex flex-col md:flex-row items-stretch gap-3 mt-5 md:mt-0">
                        <a href="#" class="py-2 px-4 rounded border border-green-700 text-gray-100 hover:bg-green-500 hover:text-black text-xs font-bold uppercase flex items-center justify-center">
                        ...
                        <a href="{{ route('editar-expediente', $expediente->id) }}" class="border border-blue-700 py-2 px-4 rounded text-gray-100 hover:bg-blue-500 hover:text-black text-xs font-bold uppercase text-center flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                class="w-6 h-6 mx-1">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <button class="border border-red-700 py-2 px-4 rounded text-gray-100 hover:bg-red-500 hover:text-black text-xs font-bold uppercase text-center flex items-center justify-center" wire:click="$dispatch('deleteAlertMedicalRecord', {{ $expediente->id }})">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                class="w-6 h-6 mx-1">
                                <path stroke-linecap="round" stroke-linejoin="round"
