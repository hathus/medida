<form class="space-y-5 md:w-1/2" wire:submit.prevent="editMedicalAppointment" novalidate>
    {{-- Peso y Talla --}}
    <div class="mt-4">
        <div class="md:flex md:flex-row md:justify-between md:space-x-3">
            <div class="mb-4 md:flex-col md:w-1/2 justify-stretch">
                {{-- Peso --}}
    ...
    <div class="mt-4">
        <div class="md:flex md:flex-row md:justify-between md:space-x-3">
            {{-- IMC --}}
            <div class="mb-4 md:flex-col md:w-1/2">
    ...
    <div class="mt-4">
        ...
        <select id="exercised" wire:model="exercised" wire:model.live="exercised"
            ...
            class="block mt-1 w-full uppercase rounded-md border-gray-300 shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-lime-500 dark:focus:border-lime-600 focus:ring-lime-500 dark:focus:ring-lime-600">
    ...
    <div class="mt-4">
        ...
        <textarea wire:model="diagnostic" wire:model.live="diagnostic" id="diagnostic" cols="15" rows="5"
            class="block mt-1 w-full rounded-md border-gray-300 shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-lime-500 dark:focus:border-lime-600 focus:ring-lime-500 dark:focus:ring-lime-600"
