    ...
    public function run(): void
    {
        ...
        $menu04_g2 = [
            ...
            [
                'name' => 'Colación Mañana',
                'items' => [ // Colación 1
                    ['id' => 1, 'desc' => 'Batido de arandanos con yogur griego', 'quant' => '1 vaso', 'calories' => 200],
                    ['id' => 2, 'desc' => 'Puñado de almendras', 'quant' => '30 g', 'calories' => 150],
                    ['id' => 3, 'desc' => 'Manzana verde', 'quant' => '1 pieza', 'calories' => 50],
                ]
            ],
            [
                'name' => 'Comida',
                'items' => [ // Comida
                    ['id' => 1, 'desc' => 'Ensalada de atún con lechuga, tomate, pepino y aderezo ligero', 'quant' => '-', 'calories' => 350],
                    ['id' => 2, 'desc' => 'Cereal de grano cocido', 'quant' => '1 taza', 'calories' => 200],
                    ['id' => 3, 'desc' => 'Agua de limón sin azúcar', 'quant' => '1 vaso', 'calories' => 0],
            ...
            [
                'name' => 'Cena',
                'items' => [ // Cena
                    ['id' => 1, 'desc' => 'Salmón a la parrilla con limón', 'quant' => '150 g', 'calories' => 300],
                    ['id' => 2, 'desc' => 'Brócoli al vapor', 'quant' => '2 tazas', 'calories' => 100],
                    ['id' => 3, 'desc' => 'Agua mineral sin gas', 'quant' => '1 vaso', 'calories' => 0],
                ]
            ],
            [
        ...
        $menu05_g2 = [
            ...
            [
                'name' => 'Comida',
                'items' => [ // Comida
                    ['id' => 1, 'desc' => 'Ensalada de espinacas, fresas y queso feta con aderezo balsámico', 'quant' => '-', 'calories' => 350],
                    ['id' => 2, 'desc' => 'Pechuga de pollo a la parrilla', 'quant' => '150 g', 'calories' => 250],
                    ['id' => 3, 'desc' => 'Agua mineral sin gas', 'quant' => '1 vaso', 'calories' => 0],
            ...
            [
                ...
                'items' => [ // Cena
                    ['id' => 1, 'desc' => 'Salmón al horno con limón', 'quant' => '150 g', 'calories' => 300],
                    ['id' => 2, 'desc' => 'Espárragos a la parrilla', 'quant' => '1 taza', 'calories' => 50],
                    ['id' => 3, 'desc' => 'Infusión de hierbas sin azúcar', 'quant' => '1 vaso', 'calories' => 0],
                ]
            ],
            [
        ...
        DB::table('recipes')->insert([
            'name' => 'Menu 02',
            'total_cal' => '2160', // Este campo corresponde al total de la tabla de excel
            'group_id' => '2',
            'tempos' => json_encode($menu02_g2),
            'created_at' => date('Y-m-d H:i:s'),
            'updated_at' => date('Y-m-d H:i:s'),
        ]);
